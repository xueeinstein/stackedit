...
gulp.task('copy-mathjax-fonts', function() {
  return gulp.src([
            './public/res/bower-libs/MathJax/fonts/HTML-CSS/TeX/woff/*'
          ])
          .pipe(gulp.dest('./nw/res/bower-libs/MathJax/fonts/HTML-CSS/TeX/woff'));
});
gulp.task('copy-nw-resmin', function() {
  return gulp.src('./public/res-min/**/*')
          .pipe(gulp.dest('./nw/res-min'));
});
gulp.task('copy-nw-packageJson', function() {
  return gulp.src('./package.json')
          .pipe(gulp.dest('./nw/'));
});
gulp.task('copy-nw-views', function() {
  return gulp.src('./views/*')
          .pipe(gulp.dest('./nw/'));
});
gulp.task('clean-nw', function() {
  return gulp.src('./nw').pipe(clean());
});
gulp.task('shrink-mathjax', function() {
  return gulp.src('./nw/res/bower-libs/MathJax/fonts')
          .pipe(clean());
});

gulp.task('copy-nw', function(cb) {
  runSequence('clean-nw',
              ['copy-nw-resmin',
              'copy-mathjax',
              'copy-nw-views',
              'copy-nw-packageJson'],
              'copy-mathjax-fonts', cb);
});
gulp.task('nwapp', ['copy-nw'], function() {
